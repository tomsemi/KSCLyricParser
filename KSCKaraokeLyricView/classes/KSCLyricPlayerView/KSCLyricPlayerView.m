...
@implementation KSCLyricPlayerView
...
- (void)setupLabels {
    lyricTop = [[KSCKaraokeLyricView alloc] init];
    lyricBottom = [[KSCKaraokeLyricView alloc] init];
...
- (void)setupLabelConstraintsForPosition:(PlayerLyricPosition)pos {
    ...
    NSDictionary *metrics = @{ @"topMargin" : @(kKSCLyricPlayerPadding),
                               @"bottomMargin" : @(kKSCLyricPlayerPadding)
                            };
...
- (void)showNextLabel {
    ...
    KSCKaraokeLyricView *lyricLabel;
...
- (void)handleAnimationAndShowLabel:(NSTimer *)atimer {
    ...
    KSCKaraokeLyricView *lyricWillAnimate = (nextLabelHaveToUpdate == kPlayerLyricPositionTop) ? lyricBottom : lyricTop;
...
- (KSCKaraokeLyricView *)reuseLyricView {
    KSCKaraokeLyricView *reusedView = (nextLabelHaveToUpdate == kPlayerLyricPositionTop) ? lyricTop : lyricBottom;
