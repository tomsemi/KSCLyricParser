...
@interface ViewController ()<KSCKaraokeLyricViewDelegate>
@property (weak, nonatomic) IBOutlet KSCKaraokeLyricView *lyricView;
@property (weak, nonatomic) IBOutlet UIButton *startButton;

@property (weak, nonatomic) IBOutlet KSCKaraokeLyricView *keyTimeLyricView;
